...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %if.end
  ...
  store i8* %call5.i191, i8** %11, align 8, !tbaa !170
...
invoke.cont11:                                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %16 = load i64, i64* %15, align 8, !tbaa !174
...
invoke.cont14:                                    ; preds = %invoke.cont11
  ...
  store i8 0, i8* %24, align 4, !tbaa !20
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [7 x i8*] }, { [7 x i8*] }* @_ZTV8CBFormat, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %18, align 8, !tbaa !10
...
for.body45.us:                                    ; preds = %for.cond64.for.cond.cleanup67_crit_edge.us, %for.body45.lr.ph
  ...
  %vtable58.us = load i1 (%class.CBFormat*, i32, i1, i32)**, i1 (%class.CBFormat*, i32, i1, i32)*** %25, align 8, !tbaa !10
...
for.body68.us:                                    ; preds = %for.inc77.us, %for.body45.us
  ...
  %37 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i198, align 8, !tbaa !174
  ...
  %39 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %38, align 8, !tbaa !33
  %40 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %39, align 8, !tbaa !138
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  ...
  %50 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !174
  ...
  %52 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %51, align 8, !tbaa !33
  %53 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %52, align 8, !tbaa !138
...
for.body45:                                       ; preds = %for.cond.cleanup67, %for.body45.lr.ph
  ...
  call void @llvm_hpvm_untrack_mem(i8* nonnull %call15) #24
  call void @llvm_hpvm_untrack_mem(i8* nonnull %26) #24
  %vtable58 = load i1 (%class.CBFormat*, i32, i1, i32)**, i1 (%class.CBFormat*, i32, i1, i32)*** %25, align 8, !tbaa !10
...
if.end.i:                                         ; preds = %if.else, %for.cond.cleanup67, %for.cond64.for.cond.cleanup67_crit_edge.us
  ...
  %56 = load i64, i64* %13, align 8, !tbaa !171
  %57 = load i64, i64* %15, align 8, !tbaa !174
...
for.body.i:                                       ; preds = %for.body.i, %if.end.i
  ...
  %60 = load i8*, i8** %59, align 8, !tbaa !33
  call void @free(i8* %60) #24
  %inc.i = add i32 %soundIdx.014.i, 1
  %conv.i203 = zext i32 %inc.i to i64
  %61 = load i64, i64* %13, align 8, !tbaa !171
  %62 = load i64, i64* %15, align 8, !tbaa !174
...
if.end.i211:                                      ; preds = %ehcleanup91, %lpad13, %lpad10
  ...
  %66 = load i64, i64* %65, align 8, !tbaa !171
  %67 = load i64, i64* %.pre-phi, align 8, !tbaa !174
...
for.body.i223:                                    ; preds = %for.body.i223, %if.end.i211
  ...
  %71 = load i64, i64* %65, align 8, !tbaa !171
  %72 = load i64, i64* %.pre-phi, align 8, !tbaa !174
...
if.then:                                          ; preds = %entry
  ...
  %1 = load %"class.ILLIXR_AUDIO::Sound"*, %"class.ILLIXR_AUDIO::Sound"** %add.ptr.i, align 8, !tbaa !33
  %amp = getelementptr inbounds %"class.ILLIXR_AUDIO::Sound", %"class.ILLIXR_AUDIO::Sound"* %1, i64 0, i32 5
  %2 = load float, float* %amp, align 4, !tbaa !136
  %conv = fpext float %2 to double
  %arrayidx = getelementptr inbounds i16, i16* %sampleTemp, i64 %call25
  %3 = load i16, i16* %arrayidx, align 2, !tbaa !205
  ...
  store float %conv7, float* %arrayidx9, align 4, !tbaa !36
  br label %if.end
...
; Function Attrs: nounwind uwtable
define %struct.out.wrapperNormalization_fxp @wrapperNormalization_fxp_cloned(%"class.std::vector.6"* in out %soundSrcs, i64 %bytes_soundSrcs, i64 %nSamples, i64 %soundSrcsSize, i16* nocapture readnone %sampleTemp, i64 %bytes_sampleTemp) #6 {
entry:
...
entry:
  ...
  %cmp = icmp slt i64 %call13, %soundSrcsSize
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %_M_start.i = getelementptr inbounds %"class.std::vector.6", %"class.std::vector.6"* %soundSrcs, i64 0, i32 0, i32 0, i32 0
  %0 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !174
  %add.ptr.i = getelementptr inbounds %"class.ILLIXR_AUDIO::Sound"*, %"class.ILLIXR_AUDIO::Sound"** %0, i64 %call13
  %1 = load %"class.ILLIXR_AUDIO::Sound"*, %"class.ILLIXR_AUDIO::Sound"** %add.ptr.i, align 8, !tbaa !33
  %BEncoder = getelementptr inbounds %"class.ILLIXR_AUDIO::Sound", %"class.ILLIXR_AUDIO::Sound"* %1, i64 0, i32 3
  %2 = load %class.CAmbisonicEncoderDist*, %class.CAmbisonicEncoderDist** %BEncoder, align 8, !tbaa !140
  ...
  %3 = load %class.CBFormat*, %class.CBFormat** %BFormat, align 8, !tbaa !139
...
for.cond2.preheader.lr.ph.i:                      ; preds = %for.body
  ...
  %3 = load %"class.ILLIXR_AUDIO::Sound"*, %"class.ILLIXR_AUDIO::Sound"** %add.ptr.i, align 8, !tbaa !33
...
for.cond2.preheader.us.i:                         ; preds = %for.cond2.for.inc10_crit_edge.us.i, %for.cond2.preheader.us.preheader.i
  ...
  %13 = load float*, float** %arrayidx.i.us.i, align 8, !tbaa !33
  %arrayidx.i22.us.i = getelementptr inbounds float*, float** %.pre.i, i64 %indvars.iv29.i
  %14 = load float*, float** %arrayidx.i22.us.i, align 8, !tbaa !33
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %16 = bitcast float* %15 to <4 x float>*
  %wide.load = load <4 x float>, <4 x float>* %16, align 4, !tbaa !36, !alias.scope !206
  %17 = getelementptr inbounds float, float* %15, i64 4
  %18 = bitcast float* %17 to <4 x float>*
  %wide.load18 = load <4 x float>, <4 x float>* %18, align 4, !tbaa !36, !alias.scope !206
  %19 = getelementptr inbounds float, float* %14, i64 %index
  %20 = bitcast float* %19 to <4 x float>*
  %wide.load19 = load <4 x float>, <4 x float>* %20, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %21 = getelementptr inbounds float, float* %19, i64 4
  %22 = bitcast float* %21 to <4 x float>*
  %wide.load20 = load <4 x float>, <4 x float>* %22, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %23 = fadd <4 x float> %wide.load, %wide.load19
  %24 = fadd <4 x float> %wide.load18, %wide.load20
  %25 = bitcast float* %19 to <4 x float>*
  store <4 x float> %23, <4 x float>* %25, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %26 = bitcast float* %21 to <4 x float>*
  store <4 x float> %24, <4 x float>* %26, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %index.next = or i64 %index, 8
  %27 = getelementptr inbounds float, float* %13, i64 %index.next
  %28 = bitcast float* %27 to <4 x float>*
  %wide.load.1 = load <4 x float>, <4 x float>* %28, align 4, !tbaa !36, !alias.scope !206
  %29 = getelementptr inbounds float, float* %27, i64 4
  %30 = bitcast float* %29 to <4 x float>*
  %wide.load18.1 = load <4 x float>, <4 x float>* %30, align 4, !tbaa !36, !alias.scope !206
  %31 = getelementptr inbounds float, float* %14, i64 %index.next
  %32 = bitcast float* %31 to <4 x float>*
  %wide.load19.1 = load <4 x float>, <4 x float>* %32, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %33 = getelementptr inbounds float, float* %31, i64 4
  %34 = bitcast float* %33 to <4 x float>*
  %wide.load20.1 = load <4 x float>, <4 x float>* %34, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %35 = fadd <4 x float> %wide.load.1, %wide.load19.1
  %36 = fadd <4 x float> %wide.load18.1, %wide.load20.1
  %37 = bitcast float* %31 to <4 x float>*
  store <4 x float> %35, <4 x float>* %37, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %38 = bitcast float* %33 to <4 x float>*
  store <4 x float> %36, <4 x float>* %38, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %index.next.1 = add i64 %index, 16
  %niter.nsub.1 = add i64 %niter, -2
  %niter.ncmp.1 = icmp eq i64 %niter.nsub.1, 0
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %40 = bitcast float* %39 to <4 x float>*
  %wide.load.epil = load <4 x float>, <4 x float>* %40, align 4, !tbaa !36, !alias.scope !206
  %41 = getelementptr inbounds float, float* %39, i64 4
  %42 = bitcast float* %41 to <4 x float>*
  %wide.load18.epil = load <4 x float>, <4 x float>* %42, align 4, !tbaa !36, !alias.scope !206
  %43 = getelementptr inbounds float, float* %14, i64 %index.unr
  %44 = bitcast float* %43 to <4 x float>*
  %wide.load19.epil = load <4 x float>, <4 x float>* %44, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %45 = getelementptr inbounds float, float* %43, i64 4
  %46 = bitcast float* %45 to <4 x float>*
  %wide.load20.epil = load <4 x float>, <4 x float>* %46, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %47 = fadd <4 x float> %wide.load.epil, %wide.load19.epil
  %48 = fadd <4 x float> %wide.load18.epil, %wide.load20.epil
  %49 = bitcast float* %43 to <4 x float>*
  store <4 x float> %47, <4 x float>* %49, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %50 = bitcast float* %45 to <4 x float>*
  store <4 x float> %48, <4 x float>* %50, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  br label %middle.block
...
for.body4.us.i.prol:                              ; preds = %for.body4.us.i.prol, %for.body4.us.i.preheader
  ...
  %53 = load float, float* %arrayidx.us.i.prol, align 4, !tbaa !36
  %arrayidx9.us.i.prol = getelementptr inbounds float, float* %14, i64 %indvars.iv.i.prol
  %54 = load float, float* %arrayidx9.us.i.prol, align 4, !tbaa !36
...
for.body4.us.i:                                   ; preds = %for.body4.us.i, %for.body4.us.i.prol.loopexit
  ...
  %56 = load float, float* %arrayidx.us.i, align 4, !tbaa !36
  %arrayidx9.us.i = getelementptr inbounds float, float* %14, i64 %indvars.iv.i
  %57 = load float, float* %arrayidx9.us.i, align 4, !tbaa !36
  ...
  %58 = load float, float* %arrayidx.us.i.1, align 4, !tbaa !36
  %arrayidx9.us.i.1 = getelementptr inbounds float, float* %14, i64 %indvars.iv.next.i
  %59 = load float, float* %arrayidx9.us.i.1, align 4, !tbaa !36
  ...
  %60 = load float, float* %arrayidx.us.i.2, align 4, !tbaa !36
  %arrayidx9.us.i.2 = getelementptr inbounds float, float* %14, i64 %indvars.iv.next.i.1
  %61 = load float, float* %arrayidx9.us.i.2, align 4, !tbaa !36
  ...
  %62 = load float, float* %arrayidx.us.i.3, align 4, !tbaa !36
  %arrayidx9.us.i.3 = getelementptr inbounds float, float* %14, i64 %indvars.iv.next.i.2
  %63 = load float, float* %arrayidx9.us.i.3, align 4, !tbaa !36
...
entry:
  ...
  ret %struct.out.wrapperSumBF_fxp undef
}
...
!9 = !{%struct.out.encoderPipeline (%"class.std::vector.6"*, i64, i64, i64, i16*, i64, %class.CBFormat*, i64)* @encoderPipeline_cloned}
!10 = !{!11, !11, i64 0}
...
!182 = !{!172, !31, i64 16}
!183 = !{!184, !31, i64 0}
!184 = !{!"_ZTS6RootIn", !31, i64 0, !149, i64 8, !149, i64 16, !149, i64 24, !31, i64 32, !149, i64 40, !31, i64 48, !149, i64 56}
!185 = !{!184, !149, i64 8}
!186 = !{!184, !149, i64 16}
!187 = !{!184, !149, i64 24}
!188 = !{!184, !31, i64 32}
...
!193 = distinct !{!193, !44}
!194 = distinct !{!194, !35}
!195 = distinct !{!195, !111, !44}
!196 = distinct !{!196, !44}
!197 = distinct !{!197, !35}
!198 = distinct !{!198, !111, !44}
!199 = distinct !{!199, !44}
!200 = distinct !{!200, !35}
!201 = distinct !{!201, !111, !44}
!202 = distinct !{!202, !44}
!203 = distinct !{!203, !35}
!204 = distinct !{!204, !111, !44}
!205 = !{!161, !161, i64 0}
!206 = !{!207}
