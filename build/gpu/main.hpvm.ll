...
for.body5.us:                                     ; preds = %for.body5.us, %for.cond1.preheader.us
  ...
  %3 = load i16, i16* %arrayidx.us, align 2, !tbaa !204
  ...
  %5 = load i16, i16* %arrayidx.us.1, align 2, !tbaa !204
...
for.body5.us.epil:                                ; preds = %for.cond1.for.cond.cleanup4_crit_edge.us.unr-lcssa
  ...
  %7 = load i16, i16* %arrayidx.us.epil, align 2, !tbaa !204
...
!5 = !{%struct.out.wrapperNormalization_fxp (%"class.std::vector.6"*, i64, i64, i64, i16*)* @wrapperNormalization_fxp_cloned}
