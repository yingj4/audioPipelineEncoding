...
for.cond.cleanup8:                                ; preds = %for.cond10.for.cond.cleanup12_crit_edge.us, %for.cond6.preheader, %arrayctor.cont
  ...
  %75 = load i8*, i8** %73, align 8, !tbaa !169
  ...
  %76 = load i8*, i8** %73, align 8, !tbaa !169
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %21 = bitcast float* %20 to <4 x float>*
  %wide.load = load <4 x float>, <4 x float>* %21, align 4, !tbaa !32, !alias.scope !205
  %22 = getelementptr inbounds float, float* %20, i64 4
  %23 = bitcast float* %22 to <4 x float>*
  %wide.load39 = load <4 x float>, <4 x float>* %23, align 4, !tbaa !32, !alias.scope !205
  %24 = getelementptr inbounds float, float* %19, i64 %index
  %25 = bitcast float* %24 to <4 x float>*
  %wide.load40 = load <4 x float>, <4 x float>* %25, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %26 = getelementptr inbounds float, float* %24, i64 4
  %27 = bitcast float* %26 to <4 x float>*
  %wide.load41 = load <4 x float>, <4 x float>* %27, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %28 = fadd <4 x float> %wide.load, %wide.load40
  %29 = fadd <4 x float> %wide.load39, %wide.load41
  %30 = bitcast float* %24 to <4 x float>*
  store <4 x float> %28, <4 x float>* %30, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %31 = bitcast float* %26 to <4 x float>*
  store <4 x float> %29, <4 x float>* %31, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %index.next = or i64 %index, 8
  %32 = getelementptr inbounds float, float* %18, i64 %index.next
  %33 = bitcast float* %32 to <4 x float>*
  %wide.load.1 = load <4 x float>, <4 x float>* %33, align 4, !tbaa !32, !alias.scope !205
  %34 = getelementptr inbounds float, float* %32, i64 4
  %35 = bitcast float* %34 to <4 x float>*
  %wide.load39.1 = load <4 x float>, <4 x float>* %35, align 4, !tbaa !32, !alias.scope !205
  %36 = getelementptr inbounds float, float* %19, i64 %index.next
  %37 = bitcast float* %36 to <4 x float>*
  %wide.load40.1 = load <4 x float>, <4 x float>* %37, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %38 = getelementptr inbounds float, float* %36, i64 4
  %39 = bitcast float* %38 to <4 x float>*
  %wide.load41.1 = load <4 x float>, <4 x float>* %39, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %40 = fadd <4 x float> %wide.load.1, %wide.load40.1
  %41 = fadd <4 x float> %wide.load39.1, %wide.load41.1
  %42 = bitcast float* %36 to <4 x float>*
  store <4 x float> %40, <4 x float>* %42, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %43 = bitcast float* %38 to <4 x float>*
  store <4 x float> %41, <4 x float>* %43, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %index.next.1 = add i64 %index, 16
  %niter.nsub.1 = add i64 %niter, -2
  %niter.ncmp.1 = icmp eq i64 %niter.nsub.1, 0
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %wide.load.epil = load <4 x float>, <4 x float>* %45, align 4, !tbaa !32, !alias.scope !205
  %46 = getelementptr inbounds float, float* %44, i64 4
  %47 = bitcast float* %46 to <4 x float>*
  %wide.load39.epil = load <4 x float>, <4 x float>* %47, align 4, !tbaa !32, !alias.scope !205
  %48 = getelementptr inbounds float, float* %19, i64 %index.unr
  %49 = bitcast float* %48 to <4 x float>*
  %wide.load40.epil = load <4 x float>, <4 x float>* %49, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %50 = getelementptr inbounds float, float* %48, i64 4
  %51 = bitcast float* %50 to <4 x float>*
  %wide.load41.epil = load <4 x float>, <4 x float>* %51, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  ...
  store <4 x float> %52, <4 x float>* %54, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  %55 = bitcast float* %50 to <4 x float>*
  store <4 x float> %53, <4 x float>* %55, align 4, !tbaa !32, !alias.scope !208, !noalias !205
  br label %middle.block
