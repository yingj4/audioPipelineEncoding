...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  ...
  call void @llvm_hpvm_track_mem(i8* %26, i64 %sub.ptr.sub.i) #24
  ...
  call void @llvm_hpvm_request_mem(i8* %27, i64 %sub.ptr.sub.i) #24
  call void @llvm_hpvm_request_mem(i8* nonnull %call1, i64 64) #24
  %28 = load i8*, i8** %25, align 8, !tbaa !170
  call void @llvm_hpvm_untrack_mem(i8* %28) #24
...
if.then:                                          ; preds = %entry
  ...
  %4 = load i16, i16* %arrayidx, align 2, !tbaa !204
