...
; Function Attrs: nounwind uwtable
define %struct.out.encoder_fxp @encoder_fxp_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* in out %soundSrcs, i64 %bytes_soundSrcs, i64 %nSamples, i64 %soundSrcsSize, i64 %idx_x, i64 %idx_y, i64 %idx_z, i64 %dim_x, i64 %dim_y, i64 %dim_z) #6 {
getHPVMPtrArgs:
  %soundSrcs.i8ptr = bitcast %"class.std::vector.6"* %soundSrcs to i8*
  %0 = call i8* @llvm_hpvm_cpu_argument_ptr(i8* %soundSrcs.i8ptr, i64 %bytes_soundSrcs)
  br label %entry
...
; Function Attrs: nounwind uwtable
define %emptyStruct @sumBF_fxp_cloned.3_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* in %soundSrcs, i64 %bytes_soundSrcs, %class.CBFormat* in out %sumBF, i64 %bytes_sumBF, i64 %soundSrcsSize, i64 %idx_x, i64 %idx_y, i64 %idx_z, i64 %dim_x, i64 %dim_y, i64 %dim_z) #6 {
getHPVMPtrArgs:
  %soundSrcs.i8ptr = bitcast %"class.std::vector.6"* %soundSrcs to i8*
  %0 = call i8* @llvm_hpvm_cpu_argument_ptr(i8* %soundSrcs.i8ptr, i64 %bytes_soundSrcs)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %19 = getelementptr inbounds float, float* %17, i64 4
  %20 = bitcast float* %19 to <4 x float>*
  %wide.load18 = load <4 x float>, <4 x float>* %20, align 4, !tbaa !33, !alias.scope !202
  ...
  %23 = getelementptr inbounds float, float* %21, i64 4
  %24 = bitcast float* %23 to <4 x float>*
  %wide.load20 = load <4 x float>, <4 x float>* %24, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  ...
  %31 = getelementptr inbounds float, float* %29, i64 4
  %32 = bitcast float* %31 to <4 x float>*
  %wide.load18.1 = load <4 x float>, <4 x float>* %32, align 4, !tbaa !33, !alias.scope !202
  ...
  %35 = getelementptr inbounds float, float* %33, i64 4
  %36 = bitcast float* %35 to <4 x float>*
  %wide.load20.1 = load <4 x float>, <4 x float>* %36, align 4, !tbaa !33, !alias.scope !205, !noalias !202
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %43 = getelementptr inbounds float, float* %41, i64 4
  %44 = bitcast float* %43 to <4 x float>*
  %wide.load18.epil = load <4 x float>, <4 x float>* %44, align 4, !tbaa !33, !alias.scope !202
  ...
  %wide.load20.epil = load <4 x float>, <4 x float>* %48, align 4, !tbaa !33, !alias.scope !205, !noalias !202
...
define %emptyStruct.28 @encoderPipeline_cloned.4(%"class.std::vector.6"* %soundSrcs, i64 %bytes_soundSrcs, i64 %nSamples, i64 %soundSrcsSize, i16* %sampleTemp, %class.CBFormat* %sumBF, i64 %bytes_sumBF) {
entry:
  ...
  call void @llvm_hpvm_cpu_dstack_push(i32 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  %encoder_fxp_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned_output = call %struct.out.encoder_fxp @encoder_fxp_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* %soundSrcs, i64 %0, i64 %nSamples, i64 %soundSrcsSize, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  call void @llvm_hpvm_cpu_dstack_pop()
  %1 = extractvalue %struct.out.encoder_fxp %encoder_fxp_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned_output, 0
  call void @llvm_hpvm_cpu_dstack_push(i32 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  %sumBF_fxp_cloned.3_cloned_cloned_cloned_cloned_cloned_cloned_output = call %emptyStruct @sumBF_fxp_cloned.3_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* %soundSrcs, i64 %1, %class.CBFormat* %sumBF, i64 %bytes_sumBF, i64 %soundSrcsSize, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  call void @llvm_hpvm_cpu_dstack_pop()
...
entry:
  ...
  %encoderPipeline_cloned.4.output = call %emptyStruct.28 @encoderPipeline_cloned.4(%"class.std::vector.6"* %soundSrcs, i64 %bytes_soundSrcs, i64 %nSamples, i64 %soundSrcsSize, i16* %sampleTemp, %class.CBFormat* %sumBF, i64 %bytes_sumBF)
...
!5 = !{%emptyStruct (%"class.std::vector.6"*, i64, %class.CBFormat*, i64, i64)* undef}
!6 = !{%emptyStruct.28 (%"class.std::vector.6"*, i64, i64, i64, i16*, %class.CBFormat*, i64)* undef}
!7 = !{!8, !8, i64 0}
