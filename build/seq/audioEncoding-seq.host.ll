...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  ...
  %16 = call i8* @llvm_hpvm_initializeTimerSet()
  store i8* %16, i8** @hpvmTimerSet_CPU
  ...
  %17 = bitcast %"class.std::vector.6"** %soundSrcs to i64*
  %18 = load i64, i64* %17, align 8, !tbaa !167
  %19 = bitcast i8* %call8 to i64*
  store i64 %18, i64* %19, align 1, !tbaa !180
  %bytes_soundSrcs11 = getelementptr inbounds i8, i8* %call8, i64 8
  %20 = bitcast i8* %bytes_soundSrcs11 to i64*
  store i64 %mul, i64* %20, align 1, !tbaa !182
  %nSamples = getelementptr inbounds i8, i8* %call8, i64 16
  %21 = bitcast i8* %nSamples to i32*
  store i32 1024, i32* %21, align 1, !tbaa !183
  %soundSrcsSize12 = getelementptr inbounds i8, i8* %call8, i64 20
  %22 = bitcast i8* %soundSrcsSize12 to i32*
  store i32 %conv, i32* %22, align 1, !tbaa !184
  ...
  %23 = bitcast i8* %sampleTemp14 to i16**
  store i16* %arraydecay13, i16** %23, align 1, !tbaa !185
  %sumBF15 = getelementptr inbounds i8, i8* %call8, i64 32
  %24 = bitcast i8* %sumBF15 to i8**
  store i8* %call1, i8** %24, align 1, !tbaa !186
  %bytes_sumBF16 = getelementptr inbounds i8, i8* %call8, i64 40
  %25 = bitcast i8* %bytes_sumBF16 to i64*
  store i64 64, i64* %25, align 1, !tbaa !187
  %26 = bitcast %"class.std::vector.6"** %soundSrcs to i8**
  %27 = inttoptr i64 %18 to i8*
  call void @llvm_hpvm_track_mem(i8* %27, i64 %mul) #23
  call void @llvm_hpvm_track_mem(i8* nonnull %call1, i64 64) #23
  call void @llvm_hpvm_switchToTimer(i8** @hpvmTimerSet_CPU, i32 18)
  %graph_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned = call i8* @llvm_hpvm_cpu_launch(i8* (i8*)* @LaunchDataflowGraph, i8* %call8)
  call void @llvm_hpvm_cpu_wait(i8* %graph_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned)
  %28 = load i8*, i8** %26, align 8, !tbaa !167
  call void @llvm_hpvm_request_mem(i8* %28, i64 %mul) #23
  call void @llvm_hpvm_request_mem(i8* nonnull %call1, i64 64) #23
  %29 = load i8*, i8** %26, align 8, !tbaa !167
  call void @llvm_hpvm_untrack_mem(i8* %29) #23
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %30 = load %"class.std::vector.6"*, %"class.std::vector.6"** %soundSrcs, align 8, !tbaa !167
  %_M_start.i = getelementptr inbounds %"class.std::vector.6", %"class.std::vector.6"* %30, i64 0, i32 0, i32 0, i32 0
  %31 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !171
  %add.ptr.i = getelementptr inbounds %"class.ILLIXR_AUDIO::Sound"*, %"class.ILLIXR_AUDIO::Sound"** %31, i64 %indvars.iv
  %32 = bitcast %"class.ILLIXR_AUDIO::Sound"** %add.ptr.i to %"class.std::basic_istream"***
  %33 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %32, align 8, !tbaa !30
  %34 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %33, align 8, !tbaa !135
  %call6 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi4readEPcl(%"class.std::basic_istream"* %34, i8* nonnull %14, i64 2048)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
; Function Attrs: nounwind uwtable
define %struct.out._Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs @_Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs_cloned.1_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* in out %soundSrcs, i64 %bytes_soundSrcs, i32 %nSamples, i32 %soundSrcsSize, i16* nocapture readonly %sampleTemp, i64 %idx_x, i64 %idx_y, i64 %idx_z, i64 %dim_x, i64 %dim_y, i64 %dim_z) #6 {
getHPVMPtrArgs:
...
for.body4.us:                                     ; preds = %for.body4.us, %for.cond1.preheader.us
  ...
  %4 = load i16, i16* %arrayidx.us, align 2, !tbaa !201
  ...
  %6 = load i16, i16* %arrayidx.us.1, align 2, !tbaa !201
...
for.body4.us.epil:                                ; preds = %for.cond1.for.cond.cleanup3_crit_edge.us.unr-lcssa
  ...
  %8 = load i16, i16* %arrayidx.us.epil, align 2, !tbaa !201
...
; Function Attrs: nounwind uwtable
define %struct.out._Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj @_Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* in out %soundSrcs, i64 %bytes_soundSrcs, i32 %nSamples, i32 %soundSrcsSize, i64 %idx_x, i64 %idx_y, i64 %idx_z, i64 %dim_x, i64 %dim_y, i64 %dim_z) #6 {
getHPVMPtrArgs:
  %soundSrcs.i8ptr = bitcast %"class.std::vector.6"* %soundSrcs to i8*
  %0 = call i8* @llvm_hpvm_cpu_argument_ptr(i8* %soundSrcs.i8ptr, i64 %bytes_soundSrcs)
  br label %entry
...
; Function Attrs: nounwind uwtable
define %emptyStruct @_Z9sumBF_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmP8CBFormatmj_cloned.3_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* in %soundSrcs, i64 %bytes_soundSrcs, %class.CBFormat* in out %sumBF, i64 %bytes_sumBF, i32 %soundSrcsSize, i64 %idx_x, i64 %idx_y, i64 %idx_z, i64 %dim_x, i64 %dim_y, i64 %dim_z) #6 {
getHPVMPtrArgs:
  %soundSrcs.i8ptr = bitcast %"class.std::vector.6"* %soundSrcs to i8*
  %0 = call i8* @llvm_hpvm_cpu_argument_ptr(i8* %soundSrcs.i8ptr, i64 %bytes_soundSrcs)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %18 = bitcast float* %17 to <4 x float>*
  %wide.load = load <4 x float>, <4 x float>* %18, align 4, !tbaa !33, !alias.scope !202
  %19 = getelementptr inbounds float, float* %17, i64 4
  %20 = bitcast float* %19 to <4 x float>*
  %wide.load17 = load <4 x float>, <4 x float>* %20, align 4, !tbaa !33, !alias.scope !202
  %21 = getelementptr inbounds float, float* %16, i64 %index
  %22 = bitcast float* %21 to <4 x float>*
  %wide.load18 = load <4 x float>, <4 x float>* %22, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %23 = getelementptr inbounds float, float* %21, i64 4
  %24 = bitcast float* %23 to <4 x float>*
  %wide.load19 = load <4 x float>, <4 x float>* %24, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %25 = fadd <4 x float> %wide.load, %wide.load18
  %26 = fadd <4 x float> %wide.load17, %wide.load19
  %27 = bitcast float* %21 to <4 x float>*
  store <4 x float> %25, <4 x float>* %27, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %28 = bitcast float* %23 to <4 x float>*
  store <4 x float> %26, <4 x float>* %28, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %index.next = or i64 %index, 8
  %29 = getelementptr inbounds float, float* %15, i64 %index.next
  %30 = bitcast float* %29 to <4 x float>*
  %wide.load.1 = load <4 x float>, <4 x float>* %30, align 4, !tbaa !33, !alias.scope !202
  %31 = getelementptr inbounds float, float* %29, i64 4
  %32 = bitcast float* %31 to <4 x float>*
  %wide.load17.1 = load <4 x float>, <4 x float>* %32, align 4, !tbaa !33, !alias.scope !202
  %33 = getelementptr inbounds float, float* %16, i64 %index.next
  %34 = bitcast float* %33 to <4 x float>*
  %wide.load18.1 = load <4 x float>, <4 x float>* %34, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %35 = getelementptr inbounds float, float* %33, i64 4
  %36 = bitcast float* %35 to <4 x float>*
  %wide.load19.1 = load <4 x float>, <4 x float>* %36, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %37 = fadd <4 x float> %wide.load.1, %wide.load18.1
  %38 = fadd <4 x float> %wide.load17.1, %wide.load19.1
  %39 = bitcast float* %33 to <4 x float>*
  store <4 x float> %37, <4 x float>* %39, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %40 = bitcast float* %35 to <4 x float>*
  store <4 x float> %38, <4 x float>* %40, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %index.next.1 = add i64 %index, 16
  %niter.nsub.1 = add i64 %niter, -2
  %niter.ncmp.1 = icmp eq i64 %niter.nsub.1, 0
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %42 = bitcast float* %41 to <4 x float>*
  %wide.load.epil = load <4 x float>, <4 x float>* %42, align 4, !tbaa !33, !alias.scope !202
  %43 = getelementptr inbounds float, float* %41, i64 4
  %44 = bitcast float* %43 to <4 x float>*
  %wide.load17.epil = load <4 x float>, <4 x float>* %44, align 4, !tbaa !33, !alias.scope !202
  %45 = getelementptr inbounds float, float* %16, i64 %index.unr
  %46 = bitcast float* %45 to <4 x float>*
  %wide.load18.epil = load <4 x float>, <4 x float>* %46, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %47 = getelementptr inbounds float, float* %45, i64 4
  %48 = bitcast float* %47 to <4 x float>*
  %wide.load19.epil = load <4 x float>, <4 x float>* %48, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  ...
  store <4 x float> %49, <4 x float>* %51, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  %52 = bitcast float* %47 to <4 x float>*
  store <4 x float> %50, <4 x float>* %52, align 4, !tbaa !33, !alias.scope !205, !noalias !202
  br label %middle.block
...
define %emptyStruct.28 @_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned.4(%"class.std::vector.6"* %soundSrcs, i64 %bytes_soundSrcs, i32 %nSamples, i32 %soundSrcsSize, i16* %sampleTemp, %class.CBFormat* %sumBF, i64 %bytes_sumBF) {
entry:
  call void @llvm_hpvm_cpu_dstack_push(i32 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  %_Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs_cloned.1_cloned_cloned_cloned_cloned_cloned_cloned_output = call %struct.out._Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs @_Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs_cloned.1_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* %soundSrcs, i64 %bytes_soundSrcs, i32 %nSamples, i32 %soundSrcsSize, i16* %sampleTemp, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  call void @llvm_hpvm_cpu_dstack_pop()
  %0 = extractvalue %struct.out._Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs %_Z17normalization_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPs_cloned.1_cloned_cloned_cloned_cloned_cloned_cloned_output, 0
  call void @llvm_hpvm_cpu_dstack_push(i32 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  %_Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned_output = call %struct.out._Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj @_Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* %soundSrcs, i64 %0, i32 %nSamples, i32 %soundSrcsSize, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  call void @llvm_hpvm_cpu_dstack_pop()
  %1 = extractvalue %struct.out._Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj %_Z11encoder_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjj_cloned.2_cloned_cloned_cloned_cloned_cloned_cloned_output, 0
  call void @llvm_hpvm_cpu_dstack_push(i32 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  %_Z9sumBF_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmP8CBFormatmj_cloned.3_cloned_cloned_cloned_cloned_cloned_cloned_output = call %emptyStruct @_Z9sumBF_fxpPSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmP8CBFormatmj_cloned.3_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* %soundSrcs, i64 %1, %class.CBFormat* %sumBF, i64 %bytes_sumBF, i32 %soundSrcsSize, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0)
  call void @llvm_hpvm_cpu_dstack_pop()
...
entry:
  ...
  %_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned.4.output = call %emptyStruct.28 @_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned.4(%"class.std::vector.6"* %soundSrcs, i64 %bytes_soundSrcs, i32 %nSamples, i32 %soundSrcsSize, i16* %sampleTemp, %class.CBFormat* %sumBF, i64 %bytes_sumBF)
  call void @llvm_hpvm_switchToTimer(i8** @hpvmTimerSet_CPU, i32 22)
  %_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned.4.output.addr = bitcast i8* %data.addr to %emptyStruct.28*
  store %emptyStruct.28 %_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned.4.output, %emptyStruct.28* %_Z15encoderPipelinePSt6vectorIPN12ILLIXR_AUDIO5SoundESaIS2_EEmjjPsP8CBFormatm_cloned.4.output.addr
  call void @llvm_hpvm_switchToTimer(i8** @hpvmTimerSet_CPU, i32 0)
  ret i8* null
}
