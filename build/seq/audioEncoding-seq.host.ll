...
for.cond.cleanup:                                 ; preds = %for.inc, %invoke.cont19
  %29 = bitcast i8* %call21 to i64*
  store i64 %12, i64* %29, align 1, !tbaa !183
  %bytes_soundSrcs32 = getelementptr inbounds i8, i8* %call21, i64 8
  %30 = bitcast i8* %bytes_soundSrcs32 to i64*
  store i64 %sub.ptr.sub.i, i64* %30, align 1, !tbaa !185
  %nSamples = getelementptr inbounds i8, i8* %call21, i64 16
  %31 = bitcast i8* %nSamples to i64*
  store i64 1024, i64* %31, align 1, !tbaa !186
  %soundSrcsSize33 = getelementptr inbounds i8, i8* %call21, i64 24
  %32 = bitcast i8* %soundSrcsSize33 to i64*
  store i64 %sub.ptr.div.i, i64* %32, align 1, !tbaa !187
  ...
  %33 = bitcast i8* %sampleTemp35 to i16**
  store i16* %arraydecay34, i16** %33, align 1, !tbaa !188
  %sumBF36 = getelementptr inbounds i8, i8* %call21, i64 48
  %34 = bitcast i8* %sumBF36 to i8**
  store i8* %call15, i8** %34, align 1, !tbaa !189
  %bytes_sumBF37 = getelementptr inbounds i8, i8* %call21, i64 56
  %35 = bitcast i8* %bytes_sumBF37 to i64*
  store i64 64, i64* %35, align 1, !tbaa !190
  %bytes_sampleTemp38 = getelementptr inbounds i8, i8* %call21, i64 40
  %36 = bitcast i8* %bytes_sampleTemp38 to i64*
  store i64 2048, i64* %36, align 1, !tbaa !191
...
for.body45.us:                                    ; preds = %for.cond64.for.cond.cleanup67_crit_edge.us, %for.body45.lr.ph
  ...
  %37 = load i1 (%class.CBFormat*, i32, i1, i32)*, i1 (%class.CBFormat*, i32, i1, i32)** %vfn59.us, align 8
  %call62.us = invoke zeroext i1 %37(%class.CBFormat* nonnull %17, i32 3, i1 zeroext true, i32 1024)
...
for.body68.us:                                    ; preds = %for.inc77.us, %for.body45.us
  ...
  %38 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i198, align 8, !tbaa !174
  ...
  %40 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %39, align 8, !tbaa !33
  %41 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %40, align 8, !tbaa !138
  %call76.us = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSi4readEPcl(%"class.std::basic_istream"* %41, i8* nonnull %26, i64 2048)
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  ...
  %51 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !174
  %add.ptr.i197 = getelementptr inbounds %"class.ILLIXR_AUDIO::Sound"*, %"class.ILLIXR_AUDIO::Sound"** %51, i64 %indvars.iv236
  %52 = bitcast %"class.ILLIXR_AUDIO::Sound"** %add.ptr.i197 to %"class.std::basic_istream"***
  %53 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %52, align 8, !tbaa !33
  %54 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %53, align 8, !tbaa !138
  %call28 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSi4readEPcl(%"class.std::basic_istream"* %54, i8* nonnull %26, i64 2048)
...
for.body45:                                       ; preds = %for.cond.cleanup67, %for.body45.lr.ph
  ...
  %56 = load i1 (%class.CBFormat*, i32, i1, i32)*, i1 (%class.CBFormat*, i32, i1, i32)** %vfn59, align 8
  %call62 = invoke zeroext i1 %56(%class.CBFormat* nonnull %17, i32 3, i1 zeroext true, i32 1024)
...
if.end.i:                                         ; preds = %if.else, %for.cond.cleanup67, %for.cond64.for.cond.cleanup67_crit_edge.us
  ...
  %57 = load i64, i64* %13, align 8, !tbaa !171
  %58 = load i64, i64* %15, align 8, !tbaa !174
...
for.body.i:                                       ; preds = %for.body.i, %if.end.i
  ...
  %62 = load i64, i64* %13, align 8, !tbaa !171
  %63 = load i64, i64* %15, align 8, !tbaa !174
...
ehcleanup91:                                      ; preds = %lpad60.us-lcssa, %lpad26, %lpad74.us-lcssa.us, %lpad60.us-lcssa.us
  %.sink244 = phi { i8*, i32 } [ %lpad.us-lcssa230.us, %lpad74.us-lcssa.us ], [ %55, %lpad26 ], [ %lpad.us-lcssa.us, %lpad60.us-lcssa.us ], [ %lpad.us-lcssa, %lpad60.us-lcssa ]
  %64 = extractvalue { i8*, i32 } %.sink244, 0
  %65 = extractvalue { i8*, i32 } %.sink244, 1
  call void @llvm.lifetime.end.p0i8(i64 2048, i8* nonnull %26) #24
  br label %if.end.i211
...
if.end.i211:                                      ; preds = %ehcleanup91, %lpad13, %lpad10
  ...
  %68 = load i64, i64* %.pre-phi, align 8, !tbaa !174
...
for.body.i223:                                    ; preds = %for.body.i223, %if.end.i211
  ...
  call void @free(i8* %71) #24
  %inc.i217 = add i32 %soundIdx.014.i214, 1
  %conv.i218 = zext i32 %inc.i217 to i64
  %72 = load i64, i64* %66, align 8, !tbaa !171
  %73 = load i64, i64* %.pre-phi, align 8, !tbaa !174
...
if.then:                                          ; preds = %entry
  ...
  %3 = load float, float* %amp, align 4, !tbaa !136
  %conv = fpext float %3 to double
  %arrayidx = getelementptr inbounds i16, i16* %sampleTemp, i64 %idx_y
  %4 = load i16, i16* %arrayidx, align 2, !tbaa !205
...
; Function Attrs: nounwind uwtable
define %struct.out.sumBF_fxp @sumBF_fxp_cloned.5_cloned_cloned_cloned_cloned_cloned_cloned(%"class.std::vector.6"* in %soundSrcs, i64 %bytes_soundSrcs, %class.CBFormat* in out %sumBF, i64 %bytes_sumBF, i64 %soundSrcsSize, i64 %idx_x, i64 %idx_y, i64 %idx_z, i64 %dim_x, i64 %dim_y, i64 %dim_z) #6 {
getHPVMPtrArgs:
  %soundSrcs.i8ptr = bitcast %"class.std::vector.6"* %soundSrcs to i8*
  %0 = call i8* @llvm_hpvm_cpu_argument_ptr(i8* %soundSrcs.i8ptr, i64 %bytes_soundSrcs)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %18 = bitcast float* %17 to <4 x float>*
  %wide.load = load <4 x float>, <4 x float>* %18, align 4, !tbaa !36, !alias.scope !206
  %19 = getelementptr inbounds float, float* %17, i64 4
  %20 = bitcast float* %19 to <4 x float>*
  %wide.load18 = load <4 x float>, <4 x float>* %20, align 4, !tbaa !36, !alias.scope !206
  %21 = getelementptr inbounds float, float* %16, i64 %index
  %22 = bitcast float* %21 to <4 x float>*
  %wide.load19 = load <4 x float>, <4 x float>* %22, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %23 = getelementptr inbounds float, float* %21, i64 4
  %24 = bitcast float* %23 to <4 x float>*
  %wide.load20 = load <4 x float>, <4 x float>* %24, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %25 = fadd <4 x float> %wide.load, %wide.load19
  %26 = fadd <4 x float> %wide.load18, %wide.load20
  %27 = bitcast float* %21 to <4 x float>*
  store <4 x float> %25, <4 x float>* %27, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %28 = bitcast float* %23 to <4 x float>*
  store <4 x float> %26, <4 x float>* %28, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %index.next = or i64 %index, 8
  %29 = getelementptr inbounds float, float* %15, i64 %index.next
  %30 = bitcast float* %29 to <4 x float>*
  %wide.load.1 = load <4 x float>, <4 x float>* %30, align 4, !tbaa !36, !alias.scope !206
  %31 = getelementptr inbounds float, float* %29, i64 4
  %32 = bitcast float* %31 to <4 x float>*
  %wide.load18.1 = load <4 x float>, <4 x float>* %32, align 4, !tbaa !36, !alias.scope !206
  %33 = getelementptr inbounds float, float* %16, i64 %index.next
  %34 = bitcast float* %33 to <4 x float>*
  %wide.load19.1 = load <4 x float>, <4 x float>* %34, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %35 = getelementptr inbounds float, float* %33, i64 4
  %36 = bitcast float* %35 to <4 x float>*
  %wide.load20.1 = load <4 x float>, <4 x float>* %36, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %37 = fadd <4 x float> %wide.load.1, %wide.load19.1
  %38 = fadd <4 x float> %wide.load18.1, %wide.load20.1
  %39 = bitcast float* %33 to <4 x float>*
  store <4 x float> %37, <4 x float>* %39, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %40 = bitcast float* %35 to <4 x float>*
  store <4 x float> %38, <4 x float>* %40, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %index.next.1 = add i64 %index, 16
  %niter.nsub.1 = add i64 %niter, -2
  %niter.ncmp.1 = icmp eq i64 %niter.nsub.1, 0
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %42 = bitcast float* %41 to <4 x float>*
  %wide.load.epil = load <4 x float>, <4 x float>* %42, align 4, !tbaa !36, !alias.scope !206
  %43 = getelementptr inbounds float, float* %41, i64 4
  %44 = bitcast float* %43 to <4 x float>*
  %wide.load18.epil = load <4 x float>, <4 x float>* %44, align 4, !tbaa !36, !alias.scope !206
  %45 = getelementptr inbounds float, float* %16, i64 %index.unr
  %46 = bitcast float* %45 to <4 x float>*
  %wide.load19.epil = load <4 x float>, <4 x float>* %46, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %47 = getelementptr inbounds float, float* %45, i64 4
  %48 = bitcast float* %47 to <4 x float>*
  %wide.load20.epil = load <4 x float>, <4 x float>* %48, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  ...
  store <4 x float> %49, <4 x float>* %51, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %52 = bitcast float* %47 to <4 x float>*
  store <4 x float> %50, <4 x float>* %52, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  br label %middle.block
...
!4 = !{%struct.out.wrapperNormalization_fxp (%"class.std::vector.6"*, i64, i64, i64, i16*, i64)* undef}
