...
for.cond.cleanup8:                                ; preds = %for.cond10.for.cond.cleanup12_crit_edge.us, %for.cond6.preheader, %arrayctor.cont
  ...
  %74 = load i8*, i8** %72, align 8, !tbaa !159
  ...
  %75 = load i8*, i8** %72, align 8, !tbaa !159
...
for.body4.us:                                     ; preds = %for.body4.us, %for.cond1.preheader.us
  ...
  %0 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !163
...
for.cond2.preheader.lr.ph.i.us:                   ; preds = %for.body4.us
  %2 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !163
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %19 = bitcast float* %18 to <4 x float>*
  %wide.load = load <4 x float>, <4 x float>* %19, align 4, !tbaa !32, !alias.scope !202
  %20 = getelementptr inbounds float, float* %18, i64 4
  %21 = bitcast float* %20 to <4 x float>*
  %wide.load39 = load <4 x float>, <4 x float>* %21, align 4, !tbaa !32, !alias.scope !202
  %22 = getelementptr inbounds float, float* %17, i64 %index
  %23 = bitcast float* %22 to <4 x float>*
  %wide.load40 = load <4 x float>, <4 x float>* %23, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %24 = getelementptr inbounds float, float* %22, i64 4
  %25 = bitcast float* %24 to <4 x float>*
  %wide.load41 = load <4 x float>, <4 x float>* %25, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %26 = fadd <4 x float> %wide.load, %wide.load40
  %27 = fadd <4 x float> %wide.load39, %wide.load41
  %28 = bitcast float* %22 to <4 x float>*
  store <4 x float> %26, <4 x float>* %28, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %29 = bitcast float* %24 to <4 x float>*
  store <4 x float> %27, <4 x float>* %29, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %index.next = or i64 %index, 8
  %30 = getelementptr inbounds float, float* %16, i64 %index.next
  %31 = bitcast float* %30 to <4 x float>*
  %wide.load.1 = load <4 x float>, <4 x float>* %31, align 4, !tbaa !32, !alias.scope !202
  %32 = getelementptr inbounds float, float* %30, i64 4
  %33 = bitcast float* %32 to <4 x float>*
  %wide.load39.1 = load <4 x float>, <4 x float>* %33, align 4, !tbaa !32, !alias.scope !202
  %34 = getelementptr inbounds float, float* %17, i64 %index.next
  %35 = bitcast float* %34 to <4 x float>*
  %wide.load40.1 = load <4 x float>, <4 x float>* %35, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %36 = getelementptr inbounds float, float* %34, i64 4
  %37 = bitcast float* %36 to <4 x float>*
  %wide.load41.1 = load <4 x float>, <4 x float>* %37, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %38 = fadd <4 x float> %wide.load.1, %wide.load40.1
  %39 = fadd <4 x float> %wide.load39.1, %wide.load41.1
  %40 = bitcast float* %34 to <4 x float>*
  store <4 x float> %38, <4 x float>* %40, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %41 = bitcast float* %36 to <4 x float>*
  store <4 x float> %39, <4 x float>* %41, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %index.next.1 = add i64 %index, 16
  %niter.nsub.1 = add i64 %niter, -2
  %niter.ncmp.1 = icmp eq i64 %niter.nsub.1, 0
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %43 = bitcast float* %42 to <4 x float>*
  %wide.load.epil = load <4 x float>, <4 x float>* %43, align 4, !tbaa !32, !alias.scope !202
  %44 = getelementptr inbounds float, float* %42, i64 4
  %45 = bitcast float* %44 to <4 x float>*
  %wide.load39.epil = load <4 x float>, <4 x float>* %45, align 4, !tbaa !32, !alias.scope !202
  %46 = getelementptr inbounds float, float* %17, i64 %index.unr
  %47 = bitcast float* %46 to <4 x float>*
  %wide.load40.epil = load <4 x float>, <4 x float>* %47, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %48 = getelementptr inbounds float, float* %46, i64 4
  %49 = bitcast float* %48 to <4 x float>*
  %wide.load41.epil = load <4 x float>, <4 x float>* %49, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  ...
  store <4 x float> %50, <4 x float>* %52, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  %53 = bitcast float* %48 to <4 x float>*
  store <4 x float> %51, <4 x float>* %53, align 4, !tbaa !32, !alias.scope !205, !noalias !202
  br label %middle.block
