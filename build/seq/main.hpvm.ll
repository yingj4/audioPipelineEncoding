...
entry:
  ...
  %sub.ptr.div.i = ashr exact i64 %sub.ptr.sub.i, 3
  %call1 = tail call i8* @_Znwm(i64 64) #25
  ...
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %m_nSamples.i, i8 0, i64 40, i1 false) #24
  ...
  call void @llvm.lifetime.start.p0i8(i64 2048, i8* nonnull %13) #24
...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  ...
  store i16* %arraydecay12, i16** %21, align 1, !tbaa !188
  %sumBF14 = getelementptr inbounds i8, i8* %call7, i64 40
  %22 = bitcast i8* %sumBF14 to i8**
  store i8* %call1, i8** %22, align 1, !tbaa !189
  %bytes_sumBF15 = getelementptr inbounds i8, i8* %call7, i64 48
  %23 = bitcast i8* %bytes_sumBF15 to i64*
  store i64 64, i64* %23, align 1, !tbaa !190
  %24 = bitcast %"class.std::vector.6"** %soundSrcs to i8**
  %25 = inttoptr i64 %16 to i8*
  call void @llvm_hpvm_track_mem(i8* %25, i64 %sub.ptr.sub.i) #24
  call void @llvm_hpvm_track_mem(i8* nonnull %call1, i64 64) #24
  %graphID = call i8* @llvm.hpvm.launch(i8* bitcast (%emptyStruct.29 (%"class.std::vector.6"*, i64, i64, i64, i16*, %class.CBFormat*, i64)* @encoderPipeline_cloned to i8*), i8* %call7, i1 false)
  call void @llvm.hpvm.wait(i8* %graphID)
  %26 = load i8*, i8** %24, align 8, !tbaa !170
  call void @llvm_hpvm_request_mem(i8* %26, i64 %sub.ptr.sub.i) #24
  call void @llvm_hpvm_request_mem(i8* nonnull %call1, i64 64) #24
  %27 = load i8*, i8** %24, align 8, !tbaa !170
  call void @llvm_hpvm_untrack_mem(i8* %27) #24
  call void @llvm_hpvm_untrack_mem(i8* nonnull %call1) #24
  ...
  call void @llvm.lifetime.end.p0i8(i64 2048, i8* nonnull %13) #24
  ret void

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %entry ]
  %28 = load %"class.std::vector.6"*, %"class.std::vector.6"** %soundSrcs, align 8, !tbaa !170
  %_M_start.i = getelementptr inbounds %"class.std::vector.6", %"class.std::vector.6"* %28, i64 0, i32 0, i32 0, i32 0
  %29 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !174
  ...
  %31 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %30, align 8, !tbaa !33
  %32 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %31, align 8, !tbaa !138
...
if.else.i:                                        ; preds = %if.then
  %call.i.i29 = tail call i64 @strlen(i8* nonnull %0) #24
...
if.end:                                           ; preds = %entry
  ...
  %call5.i42 = invoke i8* @_Znwm(i64 24) #25
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %if.end
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %call5.i42, i8 0, i64 24, i1 false) #24
...
_ZN12ILLIXR_AUDIO7ABAudioD2Ev.exit:               ; preds = %for.body.i, %if.end.i
  call void @free(i8* nonnull %call5.i42) #24
...
if.then:                                          ; preds = %entry
  ...
  %3 = load i16, i16* %arrayidx, align 2, !tbaa !204
...
; Function Attrs: nounwind uwtable
define %emptyStruct.28 @wrapperSumBF_fxp_cloned(%"class.std::vector.6"* in %soundSrcs, i64 %bytes_soundSrcs, %class.CBFormat* in out %sumBF, i64 %bytes_sumBF, i64 %soundSrcsSize) #6 {
entry:
...
; Function Attrs: nounwind uwtable
define %emptyStruct.29 @encoderPipeline_cloned(%"class.std::vector.6"* in out %soundSrcs, i64 %bytes_soundSrcs, i64 %nSamples, i64 %soundSrcsSize, i16* nocapture readnone %sampleTemp, %class.CBFormat* in out %sumBF, i64 %bytes_sumBF) #6 {
entry:
  ...
  %wrapperSumBF_fxp_cloned.node = call i8* @llvm.hpvm.createNode(i8* bitcast (%emptyStruct.28 (%"class.std::vector.6"*, i64, %class.CBFormat*, i64, i64)* @wrapperSumBF_fxp_cloned to i8*))
...
!4 = !{%struct.out.wrapperNormalization_fxp (%"class.std::vector.6"*, i64, i64, i64, i16*)* @wrapperNormalization_fxp_cloned}
...
!7 = !{%emptyStruct (%"class.std::vector.6"*, i64, %class.CBFormat*, i64, i64)* @sumBF_fxp_cloned}
!8 = !{%emptyStruct.28 (%"class.std::vector.6"*, i64, %class.CBFormat*, i64, i64)* @wrapperSumBF_fxp_cloned}
!9 = !{%emptyStruct.29 (%"class.std::vector.6"*, i64, i64, i64, i16*, %class.CBFormat*, i64)* @encoderPipeline_cloned}
!10 = !{!11, !11, i64 0}
