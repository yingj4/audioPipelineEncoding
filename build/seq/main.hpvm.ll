...
entry:
  ...
  store i8 0, i8* %12, align 4, !tbaa !17
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [7 x i8*] }, { [7 x i8*] }* @_ZTV8CBFormat, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %6, align 8, !tbaa !7
...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  ...
  %graphID = call i8* @llvm.hpvm.launch(i8* bitcast (%emptyStruct.28 (%"class.std::vector.6"*, i64, i64, i64, i16*, %class.CBFormat*, i64)* @encoderPipeline_cloned to i8*), i8* %call7, i1 false)
  call void @llvm.hpvm.wait(i8* %graphID)
  %25 = load i8*, i8** %23, align 8, !tbaa !167
  call void @llvm_hpvm_request_mem(i8* %25, i64 %sub.ptr.sub.i) #23
  call void @llvm_hpvm_request_mem(i8* nonnull %call1, i64 64) #23
  %26 = load i8*, i8** %23, align 8, !tbaa !167
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %27 = load %"class.std::vector.6"*, %"class.std::vector.6"** %soundSrcs, align 8, !tbaa !167
  %_M_start.i = getelementptr inbounds %"class.std::vector.6", %"class.std::vector.6"* %27, i64 0, i32 0, i32 0, i32 0
  %28 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !171
  ...
  %30 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %29, align 8, !tbaa !30
  %31 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %30, align 8, !tbaa !135
...
for.body5.us:                                     ; preds = %for.body5.us, %for.cond1.preheader.us
  ...
  store float %conv10.us, float* %arrayidx14.us, align 4, !tbaa !33
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  store float %conv10.us.1, float* %arrayidx14.us.1, align 4, !tbaa !33
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %niter.nsub.1 = add i64 %niter, -2
  %niter.ncmp.1 = icmp eq i64 %niter.nsub.1, 0
...
for.body5.us.epil:                                ; preds = %for.cond1.for.cond.cleanup4_crit_edge.us.unr-lcssa
  ...
  store float %conv10.us.epil, float* %arrayidx14.us.epil, align 4, !tbaa !33
...
; Function Attrs: nounwind uwtable
define %emptyStruct.28 @encoderPipeline_cloned(%"class.std::vector.6"* in out %soundSrcs, i64 %bytes_soundSrcs, i64 %nSamples, i64 %soundSrcsSize, i16* nocapture readnone %sampleTemp, %class.CBFormat* in out %sumBF, i64 %bytes_sumBF) #6 {
entry:
...
!3 = !{%struct.out.normalization_fxp (%"class.std::vector.6"*, i64, i64, i64, i16*)* @normalization_fxp_cloned}
!4 = !{%struct.out.encoder_fxp (%"class.std::vector.6"*, i64, i64, i64)* @encoder_fxp_cloned}
!5 = !{%emptyStruct (%"class.std::vector.6"*, i64, %class.CBFormat*, i64, i64)* @sumBF_fxp_cloned}
!6 = !{%emptyStruct.28 (%"class.std::vector.6"*, i64, i64, i64, i16*, %class.CBFormat*, i64)* @encoderPipeline_cloned}
!7 = !{!8, !8, i64 0}
...
!179 = !{!169, !28, i64 16}
!180 = !{!181, !28, i64 0}
!181 = !{!"_ZTS6RootIn", !28, i64 0, !146, i64 8, !146, i64 16, !146, i64 24, !28, i64 32, !28, i64 40, !146, i64 48}
!182 = !{!181, !146, i64 8}
!183 = !{!181, !146, i64 16}
!184 = !{!181, !146, i64 24}
!185 = !{!181, !28, i64 32}
