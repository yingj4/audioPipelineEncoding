...
for.body68.us:                                    ; preds = %for.inc77.us, %for.body45.us
  ...
  %36 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i198, align 8, !tbaa !174
  ...
  %38 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %37, align 8, !tbaa !33
  %39 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %38, align 8, !tbaa !138
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  ...
  %49 = load %"class.ILLIXR_AUDIO::Sound"**, %"class.ILLIXR_AUDIO::Sound"*** %_M_start.i, align 8, !tbaa !174
  ...
  %51 = load %"class.std::basic_istream"**, %"class.std::basic_istream"*** %50, align 8, !tbaa !33
  %52 = load %"class.std::basic_istream"*, %"class.std::basic_istream"** %51, align 8, !tbaa !138
...
if.end.i:                                         ; preds = %if.else, %for.cond.cleanup67, %for.cond64.for.cond.cleanup67_crit_edge.us
  ...
  %55 = load i64, i64* %13, align 8, !tbaa !171
  %56 = load i64, i64* %15, align 8, !tbaa !174
...
for.body.i:                                       ; preds = %for.body.i, %if.end.i
  ...
  call void @free(i8* %59) #24
  %inc.i = add i32 %soundIdx.014.i, 1
  %conv.i203 = zext i32 %inc.i to i64
  %60 = load i64, i64* %13, align 8, !tbaa !171
  %61 = load i64, i64* %15, align 8, !tbaa !174
...
if.end.i211:                                      ; preds = %ehcleanup91, %lpad13, %lpad10
  ...
  %66 = load i64, i64* %.pre-phi, align 8, !tbaa !174
...
for.body.i223:                                    ; preds = %for.body.i223, %if.end.i211
  ...
  call void @free(i8* %69) #24
  %inc.i217 = add i32 %soundIdx.014.i214, 1
  %conv.i218 = zext i32 %inc.i217 to i64
  %70 = load i64, i64* %64, align 8, !tbaa !171
  %71 = load i64, i64* %.pre-phi, align 8, !tbaa !174
