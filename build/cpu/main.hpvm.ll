...
if.then.i71:                                      ; preds = %if.else
  tail call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.10, i64 0, i64 0)) #28
  unreachable
...
if.then.i169:                                     ; preds = %if.else44
  tail call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.11, i64 0, i64 0)) #28
  unreachable
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %18 = bitcast float* %17 to <4 x float>*
  %wide.load19 = load <4 x float>, <4 x float>* %18, align 4, !tbaa !36, !alias.scope !206
  %19 = getelementptr inbounds float, float* %14, i64 %index
  %20 = bitcast float* %19 to <4 x float>*
  %wide.load20 = load <4 x float>, <4 x float>* %20, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %21 = getelementptr inbounds float, float* %19, i64 4
  %22 = bitcast float* %21 to <4 x float>*
  %wide.load21 = load <4 x float>, <4 x float>* %22, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  ...
  %30 = bitcast float* %29 to <4 x float>*
  %wide.load19.1 = load <4 x float>, <4 x float>* %30, align 4, !tbaa !36, !alias.scope !206
  %31 = getelementptr inbounds float, float* %14, i64 %index.next
  %32 = bitcast float* %31 to <4 x float>*
  %wide.load20.1 = load <4 x float>, <4 x float>* %32, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %33 = getelementptr inbounds float, float* %31, i64 4
  %34 = bitcast float* %33 to <4 x float>*
  %wide.load21.1 = load <4 x float>, <4 x float>* %34, align 4, !tbaa !36, !alias.scope !209, !noalias !206
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %42 = bitcast float* %41 to <4 x float>*
  %wide.load19.epil = load <4 x float>, <4 x float>* %42, align 4, !tbaa !36, !alias.scope !206
  %43 = getelementptr inbounds float, float* %14, i64 %index.unr
  %44 = bitcast float* %43 to <4 x float>*
  %wide.load20.epil = load <4 x float>, <4 x float>* %44, align 4, !tbaa !36, !alias.scope !209, !noalias !206
  %45 = getelementptr inbounds float, float* %43, i64 4
  %46 = bitcast float* %45 to <4 x float>*
  %wide.load21.epil = load <4 x float>, <4 x float>* %46, align 4, !tbaa !36, !alias.scope !209, !noalias !206
